    ...
    int vertiSmplNum, float vertiUpLimit, float vertiUnLimit)
{
    ...
    oss << "LiDAR3D init stas." << "\n";
    oss << "m_maxRange:" << m_maxRange << "\n";
    oss << "m_horizSmplNum:" << m_horizSmplNum << "\n";
    oss << "m_horizLeLimit:" << m_horizLeLimit << "\n";
    oss << "m_horizRiLimit:" << m_horizRiLimit << "\n";
    oss << "m_horizResolu:" << m_horizResolu << "\n";
    oss << "m_vertiSmplNum:" << m_vertiSmplNum << "\n";
    oss << "m_vertiUpLimit:" << m_vertiUpLimit << "\n";
    oss << "m_vertiUnLimit:" << m_vertiUnLimit << "\n";
    oss << "m_vertiResolu:" << m_vertiResolu << "\n\n";
