...
private:
    ...
    std::string m_cameraPoseFilename;
...
public:
    ...
    FrameObjectInfo generateMessage(float* pDepth, uint8_t* pStencil, int sector, int entityID = -1);
...
private:
    ...
    void drawVectorFromPosition(Vector3 vector, int blue, int green, int red);
